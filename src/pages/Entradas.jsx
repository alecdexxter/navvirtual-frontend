        ...
        <div className="max-w-3xl mx-auto px-6 py-12">
            ...
            <div className="flex flex-col gap-3">
                {eventos.map((ev) => (
                    ...
                    >
                        <div>
                            <h2 className="font-display font-semibold group-hover:text-fondo transition-colors">{ev.nombre}</h2>
                            <p className="text-sm text-tinta/60 group-hover:text-fondo/70 transition-colors">{ev.descripcion}</p>
                        </div>
